      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-primary to-purple-600 text-white p-8 flex-col justify-between">
        <div>
          ...
          <div className="max-w-md">
            <h2 className="text-4xl font-bold mb-6">Crea tu cuenta</h2>
            <p className="text-lg opacity-90">
              Únete a nuestra plataforma y comienza a crear códigos QR personalizados para tu negocio o proyecto.
            </p>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center md:text-left">
            ...
            <p className="text-sm text-muted-foreground mt-2">Ingresa tus datos para crear una cuenta</p>
          </div>
